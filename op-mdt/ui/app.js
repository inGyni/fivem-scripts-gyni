    ...
    /* } else if (eventData.type == "bulletin") {
      ...
      $.each(table, function (index, value) {
        if (value) {
          ...
          if (value["fullname"] && value["number"]) {
            DispatchItem += `<div class="call-bottom-info"><span class="far fa-id-badge"></span>${value["fullname"]}<span class="fas fa-mobile-alt" style="margin-left: 2vh;"></span>${value["number"]}</div>`;
          } else if (value["number"]) {
            DispatchItem += `<div class="call-bottom-info"><span class="fas fa-mobile-alt"></span>${value["number"]}</div>`;
          } else if (value["fullname"]) {
            DispatchItem += `<div class="call-bottom-info"><span class="far fa-id-badge"></span>${value["fullname"]}</div>`;
          }

          if (value["dispatchMessage"]) {
            DispatchItem += `<div class="call-bottom-info call-bottom-information"><span class="far fa-question-circle"></span>${value["dispatchMessage"]}</div>`;
          }
