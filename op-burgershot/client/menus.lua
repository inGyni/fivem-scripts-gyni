...
AddEventHandler("op-burgershot:bill", function()
    ...
    if bill ~= nil then
        ...
        TriggerServerEvent("op-burgershot:bill:player", bill.citizenid, bill.billprice)
    end
end)
