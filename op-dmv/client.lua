...
RegisterNetEvent('mt-dmv:client:AbrirMenu', function()
    exports['qb-menu']:openMenu({
      ...
      {
        header = "Start truck practical test",
      ...
      {
        header = "Start motorcycle practical test",
...
RegisterNetEvent('mt-dmv:startdriver', function()
    ...
    QBCore.Functions.SpawnVehicle(Config.VehicleModels.driver, function(veh)
        ...
        CurrentVehicle = veh
        QBCore.Functions.Notify('You have started the driving test')
        ...
        if CurrentTest == 'drive' then
            ...
            if IsPedInAnyVehicle(playerPed,  false) then
                ...
                for k,v in pairs(Config.SpeedLimits) do
                    ...
                    tooMuchSpeed = true
                        if not IsAboveSpeedLimit then
                            ...
                            QBCore.Functions.Notify('You are driving over the speedlimit.',"error")
                ...
                if health < LastVehicleHealth then
                    DriveErrors = DriveErrors + 1
                    QBCore.Functions.Notify('You hit your vehicle.')
                    QBCore.Functions.Notify("Errors:"..tostring(DriveErrors).."/" ..Config.MaxErrors, "error")
        ...
        options = {
            {
                ...
                icon = "fas fa-car",
                label = 'Talk to the driving instructor'
            },
        },
        distance = 2.5
    })
